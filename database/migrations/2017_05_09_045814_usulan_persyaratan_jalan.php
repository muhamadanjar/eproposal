...
class UsulanPersyaratanJalan extends Migration
{
    
    public function up(){
        Schema::create('usulan_persyaratan_jalan', function (Blueprint $table) {
            $table->unsignedInteger('pjalan_id');
            ...
            $table->primary(['pjalan_id', 'usulan_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('usulan_persyaratan_jalan');
    }
}
