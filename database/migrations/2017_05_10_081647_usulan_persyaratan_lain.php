...
class UsulanPersyaratanLain extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('usulan_persyaratan_lain', function (Blueprint $table) {
            $table->unsignedInteger('lain_id');
            ...
            $table->primary(['lain_id', 'usulan_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('usulan_persyaratan_lain');
    }
}
