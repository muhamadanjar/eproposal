        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
                ...
                <ul class="treeview-menu">
                  <li><a href="{{url('persyaratan/jalan')}}"><i class="fa fa-circle-o"></i> Jalan</a></li>
                  <li><a href="{{url('persyaratan/sab')}}"><i class="fa fa-circle-o"></i> SAB</a></li>
                  <li><a href="{{ url('persyaratan/plts') }}"><i class="fa fa-circle-o"></i> PLTS</a></li>
                </ul>
            </li>
          </ul>
        </li>
